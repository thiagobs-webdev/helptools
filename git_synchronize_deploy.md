...
2. Hooks - 'post-receive' is executed when a 'push' is completely finished and it's the one we are interested in.
    ...
    2.1 A blank line indicating that everything you type will be saved to this file. So let's type, press 'control-d' to save.:
        #!/bin/sh
        git --work-tree=/var/www/domain.com --git-dir=/var/repo/site.git checkout -f

    2.2 In order to execute the file, we need to set the proper permissions using:
...
2. Remote path of our repository. Tell Git to add a remote called 'live':
    ...
    git remote add rootlive ssh://root@163.47.8.214/var/repo/thiagobs.me.git
